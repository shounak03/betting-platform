      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 bg-clip-text text-transparent">
              WagerVerse
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-50 mb-8 animate-fade-in delay-200 mt-8">
